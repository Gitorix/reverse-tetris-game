...
export default function Home() {
  ...
  const testClearSound=(count:number)=>{const AudioCtx=window.AudioContext||(window as typeof window & {webkitAudioContext:typeof AudioContext}).webkitAudioContext;if(AudioCtx&&!audioRef.current)audioRef.current=new AudioCtx();setMusicOn(true);if(audioRef.current)void emitClearSound(audioRef.current,count)};
